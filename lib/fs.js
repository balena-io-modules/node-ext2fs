...
module.exports = function(filesystem, fsOptions) {

const util = require('util');
const pathModule = require('path');

const binding = require('./binding')(filesystem, fsOptions);
const fs = {};
...
// Copy-pasted from nodejs' path module
pathModule._makeLong = function(path) {

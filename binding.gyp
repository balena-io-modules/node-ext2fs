	...
	'targets': [
		{
			...
			'type': 'static_library',
			'sources': [
				'deps/e2fsprogs/lib/et/error_message.c',
				'deps/e2fsprogs/lib/et/et_name.c',
				'deps/e2fsprogs/lib/et/init_et.c',
				'deps/e2fsprogs/lib/et/com_err.c',
				'deps/e2fsprogs/lib/et/com_right.c',
			],
		},
		{
			'target_name': 'ext2fs',
